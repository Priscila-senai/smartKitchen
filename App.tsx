...
export default function App() {
  ...
  const [receitasSalvas, setReceitasSalvas] = useState<string[]>([]);
  ...
  function salvarReceita() {
    if (receita) {
      const titulo = receita.split('\n')[0]; // Primeira linha como título
      setReceitasSalvas((prev) => [...prev, titulo]);
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 24, marginTop: 4 }} style={ESTILOS.containerScroll} showsVerticalScrollIndicator={false}>
        ...
        {receita && (
          <View style={ESTILOS.content}>
            ...
            <TouchableOpacity style={[ESTILOS.button, { marginTop: 12, backgroundColor: 'green' }]} onPress={salvarReceita}>
              <Text style={ESTILOS.buttonText}>Salvar receita</Text>
